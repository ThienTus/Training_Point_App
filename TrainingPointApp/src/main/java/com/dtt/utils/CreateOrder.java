...
import static com.dtt.utils.Helpers.getAppTransId;
...
public class CreateOrder {
    ...
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            AppUser = "Điểm rèn luyện Thiên Tú";
            ...
            Items = "[]";
            BankCode = "zalopayapp";
            Description = "Thanh toán dịch vụ trên Điểm rèn luyện Thiên Tú - #" + getAppTransId();
